...
<head>
    ...
    <title>Login Upload — Gem Pearls</title>
...
<body class="bg-slate-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-xl font-bold text-slate-800">Upload Produk</h1>
            <p class="text-sm text-slate-400 mt-1">Masuk untuk menambah produk baru</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('upload.login.post') }}" class="space-y-4">
                @csrf
                <div>
