    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-60 bg-white border-r border-slate-100 flex flex-col shadow-sm flex-shrink-0">
            ...
            <nav class="flex-1 px-3 py-3 overflow-y-auto space-y-0.5">
                ...
                <p class="nav-section">Halaman Karyawan</p>
                {{-- Security --}}
                <a href="{{ route('dashboard.security') }}"
                    class="nav-link {{ request()->routeIs('dashboard.security') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="nav-icon">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.sales-staff.index') }}"
                    class="nav-link {{ request()->routeIs('admin.sales-staff*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="nav-icon">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.upload-users.index') }}"
                class="nav-link {{ request()->routeIs('admin.upload-users*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="nav-icon">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('admin.commission-users.index') }}" class="nav-link {{ request()->routeIs('admin.commission-users*') ? 'active' : '' }}">
