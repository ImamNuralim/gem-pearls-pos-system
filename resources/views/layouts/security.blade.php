...
<body class="bg-slate-50 antialiased min-h-screen">
    ...
    <nav class="bg-white border-b border-gray-200 shadow-sm px-3 sm:px-6 py-3 flex items-center justify-between sticky top-0 z-50">

    {{-- Logo --}}
    <div class="flex items-center gap-2 sm:gap-3">
        <div class="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-blue-50 flex items-center justify-center shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 sm:w-6 sm:h-6 text-blue-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        {{-- Sembunyikan teks di xs, tampil mulai sm --}}
    ...
    {{-- Clock: sembunyikan di xs, tampil mulai sm --}}
    ...
    <div class="relative" x-data="{ open: false }">
        <button @click="open = !open"
            class="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-2 rounded-xl bg-gray-50 hover:bg-blue-50 border border-gray-200 hover:border-blue-200 transition">
            ...
            {{-- Nama & role hanya tampil mulai sm --}}
